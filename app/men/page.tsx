...
export default function MenPage() {
  ...
  const certifiedCount = menProducts.filter((p) => p.isEcoVerified).length
  const estimatedCount = menProducts.filter((p) => p.isCarbonEstimated).length

  const sortProducts = (products: typeof menProducts, sortOption: SortOption) => {
  ...
  const organizeProducts = (products: typeof menProducts) => {
  ...
  const organizedProducts = organizeProducts(menProducts)
